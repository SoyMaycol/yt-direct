...
export default { request, head, stream, buildOptions, UA, API_KEY, HOST, PATH };
...
export default { fetch, CLIENT_PROFILES };
...
export default { mimeTypeToContainer, checkContainer };
...
export default { validateOptions, VALID_QUALITIES, VALID_CONTAINERS };
...
export default { DownloadStream, createStream };
